...
public interface IShipResourceAllocator
{
    ...
    public bool AllocateResources(ICoreModule.ModuleResourceRequirement resources, Vector3Int resourceAmount);
    ...
    public bool CheckResourceAvailability(ICoreModule.ModuleResourceRequirement resources, Vector3Int resourceAmount);
}
