...
public interface IShipResourceAllocator
{
    ...
    public bool AllocateResources(ICoreSystem.SystemResourceRequirement resources, Vector3Int resourceAmount);
    ...
    public bool CheckResourceAvailability(ICoreSystem.SystemResourceRequirement resources, Vector3Int resourceAmount);
}
